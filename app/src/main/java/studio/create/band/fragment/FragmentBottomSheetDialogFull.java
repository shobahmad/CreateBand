package studio.create.band.fragment;
...
public class FragmentBottomSheetDialogFull extends BottomSheetDialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        ((TextView) view.findViewById(R.id.role)).setText(people.role);
        ((TextView) view.findViewById(R.id.name_toolbar)).setText(people.name);
        ((TextView) view.findViewById(R.id.role_toolbar)).setText(people.role);
